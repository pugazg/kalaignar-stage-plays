---
scan_page: 8
page_type: vice-chancellors-note
status: transcribed
language: en
...
There is a close parallel between the nationalist Tamil poet Subramania Bharathi (after whom this University is named) and Kalaignar M. Karunanidhi in that both of them have a deep-rooted conviction in art being an agent of social transformation and the writings of both seek to release people from the shackles of slavery and show them the way of dignity and self-respect.
...
Corrected the source-printed dash in `two castes – the righteous`. The unusual no-space form `the”Bharathi Tamil Chemmal”award` is retained because it is visibly printed that way in the source.
