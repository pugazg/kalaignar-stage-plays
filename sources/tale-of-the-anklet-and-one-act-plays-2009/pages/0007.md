...
Compared directly with source pixels. Header, date, Foreword body, three-line verse, addressee block and printed signature name are faithful. The source also contains the official emblem and a handwritten signature, which remain visual elements rather than transcribed literary text.
