...
Compared directly with the controlling source pixels. Restored the source's plain printed hyphen before `he can handle it with astonishing ease`; it had previously been normalized to an en dash.