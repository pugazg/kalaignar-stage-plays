...
| 049 | corrected-and-passed | Restored source typographic apostrophes in `one’s`, `Don’t`, `artist’s`, and `don’t`; retained printed `my self` and em-dash construction. |
| 050 | corrected-and-passed | Replaced normalized numbered footnote with the printed literal asterisk form `thatha*` / `*thatha = grandfather`; surrounding quotation punctuation checked. |
