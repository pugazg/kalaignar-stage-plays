...
| 47–49 | 42–44 | `சேரன் செங்குட்டுவன்` — `காட்சி — 2` continuation/closing | not-started | Scan 47 / p.42 is next. |
...
`சேரன் செங்குட்டுவன்` scans **44–46 / printed pp.39–41** are verified: **3/10 Tamil pages verified**. Scene 1 is assembled with fidelity **PASS**; Scene 2 page gate is **1/4**; scenes assembled **1/4**.

Next source-sequential activity: verify **scan 47 / printed p.42 only**. Do not process scan 48 or assemble Scene 2 in the same activity.
