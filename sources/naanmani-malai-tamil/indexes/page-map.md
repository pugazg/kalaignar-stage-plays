...
| 32 | 27 | `சாக்ரடீஸ்` — `காட்சி—2` | not-started | One-scan scene; structural survey only. |
...
`சாக்ரடீஸ்` scans **27–31 = 5/5 pages processed and verified** for the introduction plus Scene-1 page gate. `காட்சி—1` is also assembled from the final verified records with page-record fidelity **PASS**. Overall work progress remains **5/17 verified**; scenes assembled **1/5**.

Next: verify `காட்சி—2`, scan **32** / printed p.27; do not advance to scan 33 in that same activity.
