...
| 35 | 30 | `சாக்ரடீஸ்` — `காட்சி—4` continuation | verified | Scene-4 gate 2/6; Gemini words retained including `செடுக்கிறேனா`; scan typography controls retained; no closing `*`. |
| 36–39 | 31–34 | `சாக்ரடீஸ்` — `காட்சி—4` continuation/closing | not-started | Scan 39 closes with `*`. |
...
`சாக்ரடீஸ்` scans **27–35 = 9 pages verified**. Scenes 1–3 are assembled with fidelity PASS. Scene 4 is **2/6 pages verified** and not assembled. Overall work progress: **9/17 verified**; scenes assembled **3/5**.

Next: verify `காட்சி—4` scan **36** / printed p.31 only; do not process scan 37 or assemble Scene 4 in the same activity.
