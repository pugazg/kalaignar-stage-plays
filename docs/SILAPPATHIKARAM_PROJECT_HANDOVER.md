...
Permanent instruction from the user:
...
- Do not collapse those terms into one English category during translation.
- English renderings must be decided only in a dedicated terminology/translation review.
- When English translation eventually begins, retain Kalaignar's language, rhetoric, cadence and dramatic voice rather than flattening the prose into generic modern English.

## Published English translation witness

The user has supplied/found a published English translation of this play for possible future use.

Treat it only as a **secondary collation/translation witness**. It may later help compare interpretation or translation choices, but it must never be used to alter the verified Tamil silently.

Do **not** begin English translation during the current transcription phase.
