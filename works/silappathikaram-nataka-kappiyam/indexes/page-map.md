...
| 87 | — | scene 37 | scene opening / close | verified | `காட்சி-37`; title `வடபுலப் படையெடுப்பு`; setting `சேரன் செங்குட்டுவன் அவை`; complete dense two-column transcription verified; decorative weapon/shield title artwork separated from literary text; no secure printed pagination; scan 88 begins scene 38. |
| 88 | — | scene 38 + closing tableau | scene opening / close + post-scene closing tableau | verified | `காட்சி-38`; title `கண்ணகி சிலைக்குக் கல்`; setting `இமயத்தில் - குயிலாலுவம்`; complete final-scan scene text and closing tableau inspected. Three `*` separators precede `வஞ்சிமூதூரில்` / `கண்ணகி சிலை நாட்டு விழா`. Later library stamp obscures the leading characters of two tableau lines; source-visible suffixes are archived with explicit obstruction markers. |

## Current checkpoint

Scans **1–88 are visually verified**. Detailed dramatic-body verification covers **காட்சி-1 through காட்சி-38**, and the same-scan post-scene closing tableau on scan 88 has also been inspected and archived.
