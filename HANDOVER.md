...
# CURRENT CHECKPOINT — நச்சுக்கோப்பை / BATCH 05 PASS A COMPLETE
...
- full canonical records: **50 / 63** (scans 1–50);
...
- Batch 05 Pass A: **COMPLETE — scans 41–50 / 10 of 10 initial verification PASS; H-GATE pending**;
...
1. run independent **Batch 05 H-GATE — scans 41–50** using only the attached PDF;
2. check the mandatory historical-glyph family and explicit page-level source-sensitive holds;
3. preserve Batch 01–04 unresolved scans as durable holds without looping them;
4. promote only clean Batch 05 pages to verified;
5. do not create final Batch 05 PASS unless all ten scans close;
