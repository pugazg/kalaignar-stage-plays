...
7. `works/cheran-senguttuvan/SCENE2_ASSEMBLY_FIDELITY_REVIEW.md`
8. `works/cheran-senguttuvan/scenes/02.md`
...
- `சேரன் செங்குட்டுவன்` `காட்சி — 2` — **4/4 page gate + assembly/fidelity PASS**.
...
- scans **44–49** / pp.39–44 complete through Scene 2;
- scan **50 / p.45** — not processed;
- `காட்சி—3.` spans scans **50–51** / pp.45–46.
...
- create/update the Scene-3 page-verification record, work/source progress, page maps, README files and handover after verification;
- expected durable total after success: **7/10 pages verified**, Scene-3 gate **1/2**;
