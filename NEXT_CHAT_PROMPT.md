...
Fetch live GitHub `main` first and treat it as authoritative. Preserve newer durable state. Do not reopen completed wording or prior closed work unless required by new source evidence or explicit user direction.
...
A conversation preview exposed only the first 150 pages, but raw-PDF inspection establishes **170 physical scans**. Never treat scan 150 as the source end.
...
Keep the user-supplied 1962 Madurai performance statement separate from the controlling scan's May 1956 Tiruchirappalli and September 1963 performance evidence unless a separate source resolves them.
