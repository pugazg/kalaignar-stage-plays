...
| Work | Status |
|---|---|
| [ஒரே முத்தம்](works/ore-mutham/) | **ACTIVE — 131 scans registered; source processing 35/131; verified 4; needs-review 31; historical-glyph pass 4/131; checksum recorded; structure/assembly not started; English not authorized** |
...
- printed pages directly confirmed through scan 35: **pp.6–33**;
- source-visible scene anchors currently reach `காட்சி 9.`;
- scan 130 is printed p.128 and the final dramatic page.

Processed scans 1–35:

- **verified:** `2, 3, 4, 6`;
- **needs-review:** `1, 5, 7–35`;
...
**Exact next activity:** process source scans **36–40** with direct visual fidelity, printed-page confirmation and the full 13-family historical-glyph gate.
