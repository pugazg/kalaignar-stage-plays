...
| Work | Status |
|---|---|
| [ஒரே முத்தம்](works/ore-mutham/) | **ACTIVE — 131 scans registered; source processing 20/131; verified 4; needs-review 16; historical-glyph pass 4/131; checksum pending; structure/assembly not started; English not authorized** |
...
- printed pages directly confirmed through scan 20: **pp.6–18**;
- source-visible scene anchors: scan 8 `காட்சி 1.`, scan 9 `காட்சி 2.`, scan 11 `காட்சி 3.`, scan 15 `காட்சி 4.`, scan 19 `காட்சி 5.`;
- scan 130 is printed p.128 and the final dramatic page.

Processed scans 1–20:

- **verified:** `2, 3, 4, 6`;
- **needs-review:** `1, 5, 7–20`;
...
- exact location lines for source scenes 4 and 5 remain held for enlarged review rather than inferred.

Current metrics:

- source scans registered: **131 / 131**;
- page/source processing: **20 / 131**;
...
The supplied scan is controlling authority. User catalog context remains distinct from transcription; no held text is repaired from plot continuity, OCR expectation, another edition, or modern spelling.

**Exact next activity:** process source scans **21–25** with direct visual fidelity, printed-page confirmation and the full 13-family historical-glyph gate. Preserve current holds (`1, 5, 7–20`) unless enlarged source evidence genuinely resolves them. Compute the PDF SHA-256 when byte-level hashing becomes available; do not infer a value.
