...
| Work | Status |
|---|---|
| [நச்சுக்கோப்பை](works/nachuk-koppai/) | **ACTIVE — 40/63 canonical + initial PASS; H-GATE 30/63 checked: 5 verified / 25 needs-review; Batch 04 Pass A COMPLETE scans 31–40, H-GATE next; P0 SHA-256 hold remains** |
...
Exact next activity: run **Batch 04 H-GATE for scans 31–40**. Batch 01–03 hold-bearing scans remain durably open and should not be re-looped without stronger attached-source readability. SHA-256 remains a separate P0 fingerprint hold.
