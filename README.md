...
| [மணிமகுடம்](works/manimagudam/) | **ACTIVE — 115/170 scans verified; காட்சி 1–28 page-level complete; காட்சி 29 in progress; next iteration scans 116–140** |
...
- `காட்சி 29`: begins on scan 110, verified through scan 115, continues onto scan 116;
- scans 91–115 fidelity gate: **25/25 PASS / COMPLETE, 0 unresolved readings**;
- next requested iteration: **scans 116–140**, starting scan 116 / printed page 107;
...
See `works/manimagudam/README.md`, `metadata/source.md`, `indexes/page-map.md`, `SCANS_0015_0039_VERIFICATION.md`, `SCANS_0041_0065_VERIFICATION.md`, `SCANS_0066_0090_VERIFICATION.md`, `SCANS_0091_0115_VERIFICATION.md`, and `pages/0001.md` through `pages/0115.md`.
