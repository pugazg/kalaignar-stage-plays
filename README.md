...
| [சாக்ரடீஸ்](works/socrates/) | **15/17 pages verified; Scenes 1–4 assembly/fidelity PASS; Scene 5 page gate 2/4; 4/5 scenes assembled** |
| [சேரன் செங்குட்டுவன்](works/cheran-senguttuvan/) | **Tamil source registered; verification pending** |

## Current repository phase

`சாக்ரடீஸ்` is verified through scan **41** / printed p.36. Scenes 1–4 have assembly/fidelity PASS. `காட்சி—5` now has scans 40–41 verified (**2/4 pages**). Total progress is **15/17 pages verified**, with **4/5 scenes assembled**.

For active `சாக்ரடீஸ்`, Gemini supplies lexical dialogue words as directed by the user; the scan controls headings, punctuation, long dash, speaker-label spacing, physical line boundaries and final source marks. Scan-derived dialogue words are not inserted when absent from the supplied Gemini baseline unless the user explicitly requests a word-level recheck.

Next activity: verify `காட்சி—5` scan **42** / printed p.37 only. Do not process scan 43 or assemble `காட்சி—5` in that same activity.
