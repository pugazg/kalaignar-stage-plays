...
| Work | Status |
|---|---|
| [இரத்தக் கண்ணீர்](works/iratha-kanneer/) | **ACTIVE — page layer COMPLETE / CLOSED; Tamil scene assembly 14/61 reviewed + Scene 15 draft through scan 54; fixed 10-scan iterations; next scans 55–64** |
...
- `needs-review`: **0**;
- `blocked`: **0**;
- scene assembly: **IN PROGRESS — Scenes 1–14 / 61 assembly-reviewed; Scene 15 draft through scan 54; Batches 01–03 PASS**;
