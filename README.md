...
| [மணிமகுடம்](works/manimagudam/) | **ACTIVE — 39/170 scans verified; காட்சி 1–6 page-level complete; காட்சி 7 in progress; next scan 40** |
...
- scans 14–39: dramatic body — **VERIFIED**;
- overall: **39 / 170 verified**;
- next: **scan 40 / காட்சி 7 continuation**;
...
See `works/manimagudam/README.md`, `metadata/source.md`, `indexes/page-map.md`, `SCANS_0015_0039_VERIFICATION.md`, and `pages/0001.md` through `pages/0039.md`.
