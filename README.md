...
| Work | Status |
|---|---|
| [இரத்தக் கண்ணீர்](works/iratha-kanneer/) | **ACTIVE — page layer COMPLETE / CLOSED; Tamil scene assembly 24/61 reviewed; no open draft; fixed 10-scan iterations; next scans 85–94** |
...
- `needs-review`: **0**;
- `blocked`: **0**;
- scene assembly: **IN PROGRESS — Scenes 1–24 / 61 assembly-reviewed; no open draft; Batches 01–06 PASS**;
