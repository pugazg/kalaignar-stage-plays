...
| Work | Status |
|---|---|
| [இரத்தக் கண்ணீர்](works/iratha-kanneer/) | **ACTIVE — page layer COMPLETE / CLOSED; Tamil scene assembly 16/61 reviewed + Scene 17 draft through scan 64; fixed 10-scan iterations; next scans 65–74** |
...
- `needs-review`: **0**;
- `blocked`: **0**;
- scene assembly: **IN PROGRESS — Scenes 1–16 / 61 assembly-reviewed; Scene 17 draft through scan 64; Batches 01–04 PASS**;
