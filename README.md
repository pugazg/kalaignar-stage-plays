...
| Work | Status |
|---|---|
| [நச்சுக்கோப்பை](works/nachuk-koppai/) | **ACTIVE — Tamil scene layer CLOSED/PASS; English 15/18 reviewed, Batches 01–03 PASS/LOCKED; Scene 5 source hold preserved; Scenes 16–18 next; P0 SHA-256 hold remains** |
...
Exact next activity: translate terminal remainder **Scenes 16–18**, then perform the final whole-work Tamil→English translation review before closure. SHA-256 remains a separate P0 fingerprint hold.
