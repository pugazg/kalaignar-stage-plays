...
| Work | Status |
|---|---|
| [இரத்தக் கண்ணீர்](works/iratha-kanneer/) | **ACTIVE — page layer COMPLETE / CLOSED; scans 1–188 / 188 of 188 canonical + initial-verified + H-GATE PASS + final `verified`; 37 historical-glyph corrections; next eligible phase Tamil scene assembly / page-to-scene audit** |
...
- `needs-review`: **0**;
- `blocked`: **0**;
- scene assembly: **not started; page-layer prerequisite satisfied**;
