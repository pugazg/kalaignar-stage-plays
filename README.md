...
| [மணிமகுடம்](works/manimagudam/) | **ACTIVE — 65/170 scans verified; காட்சி 1–13 page-level complete; காட்சி 14 in progress; next iteration scans 66–90** |
...
- `காட்சி 1`–`காட்சி 13`: page-level complete;
- `காட்சி 14`: begins on scan 65 and continues on scan 66;
- scans 41–65 fidelity gate: **25/25 PASS / COMPLETE**;
- next requested iteration: **scans 66–90**, starting scan 66 / printed page 57;
...
See `works/manimagudam/README.md`, `metadata/source.md`, `indexes/page-map.md`, `SCANS_0015_0039_VERIFICATION.md`, `SCANS_0041_0065_VERIFICATION.md`, and `pages/0001.md` through `pages/0065.md`.
